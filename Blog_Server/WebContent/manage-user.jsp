        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <c:forEach items="${userList}" var="u">
                ...
                <td>${u.tel}</td>
                <td>${u.createDate}</td>
                <td><a rel="${u.id }" name="see">修改</a> <a rel="${u.id }" name="delete">删除</a>
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              <tr>
                <td wdith="20%">姓名:</td>
                <td width="80%"><input type="text" value="${param.name}" class="form-control" id="truename" name="name" maxlength="10" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">用户名:</td>
                <td width="80%"><input type="text" value="${param.account }" class="form-control" id="username" name="account" maxlength="10" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">电话:</td>
                <td width="80%"><input type="text" value="${param.tel }" class="form-control" id="usertel" name="tel" maxlength="13" autocomplete="off" /></td>
              </tr>
              <!-- 
              <tr>
                <td wdith="20%">旧密码:</td>
                <td width="80%"><input type="password" class="form-control" name="oldpwd" maxlength="18" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">新密码:</td>
                <td width="80%"><input type="password" class="form-control" name="pwd" maxlength="18" autocomplete="off" /></td>
